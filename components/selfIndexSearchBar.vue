<template>
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'px'}">
			<!-- HM修改 增加进入输入状态的点击范围 -->
			<view class="content-box bg-gray" :class="{'center':mode === 2}" @click="getFocus">
				...
				<text v-if="isDelShow" class="cuIcon-roundclosefill text-gray padding-right" @click.stop="clear"></text>
				<view class="ljOptions text-black flex justify-between ">
					<view class="cuIcon-search padding-right-xs" @click="search"></view>
				</view>
			</view>
		</view>
	</view>
		...
		.content {
			...
			.content-box {
				...
				.ljBack {
					...
					top: var(--status-bar-height)+22px;
